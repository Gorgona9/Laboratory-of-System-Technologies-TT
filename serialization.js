...
function serialize () {
    ...
    let outputElement = document.getElementById('serializeResult');
...
function parseInputText (txt) {
    ...
    let splittedTxt = trimmedTxt.split(serializeItemDelimiter);
...
function deserialize () {
    ...
    let outputElement = document.getElementById('deserializeResult');
...
function formatDeserialized(arr) {
    return arr.join(serializeItemDelimiter);
}
